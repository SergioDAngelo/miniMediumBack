...
exports.routerUser.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, lastName, email, password, hashedPassword, user, error_1;
...
exports.routerUser.post('/signin', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, passwordMatches, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
